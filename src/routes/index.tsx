...
const SecurityPage = React.lazy(() => import('../pages/SecurityPage').then(mod => ({ default: mod.SecurityPage })))
const ApiKeysPage = React.lazy(() => import('../pages/ApiKeysPage').then(mod => ({ default: mod.ApiKeysPage })))
const ParticipantsPage = React.lazy(() => import('../pages/ParticipantsPage').then(mod => ({ default: mod.ParticipantsPage })))
const RoundTablePage = React.lazy(() => import('../pages/RoundTablePage').then(mod => ({ default: mod.RoundTablePage })))
...
function WizardStepGuard({ children, requiredStep }: { children: React.ReactNode, requiredStep: number }) {
  ...
  if (wizardStep < requiredStep) {
    const redirectPath = wizardStep === 0 ? '/security' : 
                         wizardStep === 1 ? '/apiKeys' : 
                         wizardStep === 2 ? '/participants' : '/';
