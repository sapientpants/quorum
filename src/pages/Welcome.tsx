  ...
  return (
    <div className="min-h-screen flex flex-col bg-app text-app transition-colors duration-300 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0 pointer-events-none">
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-purple-600/20 rounded-full filter blur-3xl opacity-70 animate-pulse"
          style={{ animationDuration: "8s" }}
        ></div>
        <div
          className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-blue-600/20 rounded-full filter blur-3xl opacity-70 animate-pulse"
          style={{ animationDuration: "10s", animationDelay: "1s" }}
        ></div>
        <div
          className="absolute top-2/3 right-1/3 w-64 h-64 bg-indigo-600/20 rounded-full filter blur-3xl opacity-50 animate-pulse"
          ...
          <ul className="text-left max-w-lg mx-auto mb-8 space-y-3">
            <li className="flex items-start">
              <Icon
                ...
                className="w-5 h-5 text-purple-500 mt-1 mr-2 flex-shrink-0"
              />
              <span className="text-foreground">
                {t("welcome.features.customParticipants")}
              </span>
            </li>
            <li className="flex items-start">
              <Icon
            ...
            <li className="flex items-start">
              ...
              />
              <span className="text-foreground">
                {t("welcome.features.saveConfigs")}
              </span>
            </li>
            <li className="flex items-start">
              <Icon
