...
export function ParticipantConfigStep({ onNext, onBack }: ParticipantConfigStepProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2">{t('wizard.participants.title')}</h2>
      ...
      {participants.length > 0 && !showForm && (
        <div className="space-y-4">
          <h3 className="text-lg font-medium">{t('wizard.participants.currentParticipants')}</h3>
