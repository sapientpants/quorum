...
vi.mock("../SecurityStep", () => ({
  SecurityStep: ({
    ...
    <div data-testid="security-step">
      <button data-testid="security-next" onClick={onNext}>
        Next
      </button>
      <button data-testid="security-back" onClick={onBack}>
        Back
      </button>
    </div>
  ),
...
vi.mock("../ApiKeyStep", () => ({
  ApiKeyStep: ({
    ...
    <div data-testid="api-key-step">
      <button data-testid="api-key-next" onClick={onNext}>
        Next
      </button>
      <button data-testid="api-key-back" onClick={onBack}>
        Back
      </button>
    </div>
  ),
...
vi.mock("../ParticipantConfigStep", () => ({
  ParticipantConfigStep: ({
    ...
    <div data-testid="participant-config-step">
      <button data-testid="participant-next" onClick={onNext}>
        Next
      </button>
      <button data-testid="participant-back" onClick={onBack}>
        Back
      </button>
    </div>
  ),
...
vi.mock("../WizardNavigation", () => ({
  WizardNavigation: ({
    ...
    <div data-testid="wizard-navigation">
      ...
      <button data-testid="nav-next" onClick={onNext} disabled={nextDisabled}>
