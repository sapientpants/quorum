  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        'wizard.apiKeys.description': 'Add your API keys to use the application',
...
describe('ApiKeyStep', () => {
  ...
  it('renders the component with title and description', () => {
    ...
    expect(screen.getByText('Add your API keys to use the application')).toBeInTheDocument()
  ...
  it('shows warning when no API keys are present', () => {
    ...
    expect(screen.getByText(/You need at least one valid API key to continue/)).toBeInTheDocument()
  ...
  it('stores API key in sessionStorage when preference is session', () => {
    ...
    expect(sessionStorageMock.setItem).toHaveBeenCalledWith('openai_api_key', 'test-key')
  ...
  it('removes API key from storage when key is removed', () => {
    ...
    expect(sessionStorageMock.removeItem).toHaveBeenCalledWith('openai_api_key')
  })
