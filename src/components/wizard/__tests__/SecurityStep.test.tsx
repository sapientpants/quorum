  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        "wizard.security.localStorage.description":
          "Store keys in browser local storage",
        "wizard.security.sessionOnly.title": "Session Storage",
        "wizard.security.sessionOnly.description":
          "Store keys for this session only",
...
const mockPreferences = {
  keyStoragePreference: "local" as KeyStoragePreference,
};
...
describe("SecurityStep", () => {
  ...
  it("renders the component with title and description", () => {
    ...
    expect(
      screen.getByText("Choose how to store your API keys"),
    ).toBeInTheDocument();
  });
