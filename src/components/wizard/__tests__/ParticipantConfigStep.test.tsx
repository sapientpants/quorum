    ...
    return {
      t: (str: string) => {
        ...
        const translations: Record<string, string> = {
          ...
          "wizard.participants.description":
            "Add at least one AI participant to create a roundtable conversation.",
          "wizard.participants.complete": "Complete",
          "wizard.navigation.back": "Back",
          "wizard.participants.noParticipants":
...
vi.mock("../../ui/button", () => ({
  Button: ({
    ...
    const testId =
      typeof children === "string" && children.toLowerCase() === "complete"
        ? "button-complete"
...
describe("ParticipantConfigStep", () => {
  ...
  it("renders the component with title and description", () => {
    ...
    expect(
      screen.getByText(/Add at least one AI participant/),
    ).toBeInTheDocument();
  });
