...
describe("WizardNavigation", () => {
  ...
  it('shows "Complete" text on last step instead of "Next"', () => {
    render(
      <WizardNavigation {...defaultProps} currentStep={2} totalSteps={3} />,
    );
  ...
  it("disables next button when nextDisabled is true", () => {
    render(<WizardNavigation {...defaultProps} nextDisabled={true} />);
  ...
  it("enables next button when nextDisabled is false", () => {
    render(<WizardNavigation {...defaultProps} nextDisabled={false} />);
