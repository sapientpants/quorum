...
describe('WizardProgress', () => {
  it('renders with correct number of steps', () => {
    ...
    const stepIndicators = screen.getAllByText(/Security|API Keys|Participants/)
  ...
  it('highlights the current step and previous steps', () => {
    const { rerender } = render(<WizardProgress currentStep={0} totalSteps={3} />)
  ...
  it('sets the progress bar width correctly', () => {
    ...
    const progressBar = document.querySelector('.bg-gradient-to-r.from-purple-500.to-blue-500.transition-all')
