  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        <h2 className="text-2xl font-bold mb-2">{t('wizard.security.title')}</h2>
      ...
      <div className="space-y-4">
        ...
        >
          <div className="flex items-start gap-3">
            <div className={`mt-0.5 rounded-full w-5 h-5 flex items-center justify-center border ${
              selectedStorage === 'local' ? 'border-primary' : 'border-muted-foreground'
            }`}>
              {selectedStorage === 'local' && (
            ...
            <div>
              <h3 className="font-medium text-lg">{t('wizard.security.localStorage.title')}</h3>
        ...
        >
          <div className="flex items-start gap-3">
            <div className={`mt-0.5 rounded-full w-5 h-5 flex items-center justify-center border ${
              selectedStorage === 'session' ? 'border-primary' : 'border-muted-foreground'
            }`}>
              {selectedStorage === 'session' && (
                <div className="w-3 h-3 rounded-full bg-primary" />
              )}
            ...
            <div>
              <h3 className="font-medium text-lg">{t('wizard.security.sessionOnly.title')}</h3>
              <p className="text-muted-foreground text-sm mt-1">
        ...
        >
          <div className="flex items-start gap-3">
            <div className={`mt-0.5 rounded-full w-5 h-5 flex items-center justify-center border ${
              selectedStorage === 'none' ? 'border-primary' : 'border-muted-foreground'
            }`}>
              {selectedStorage === 'none' && (
                <div className="w-3 h-3 rounded-full bg-primary" />
              )}
            ...
            <div>
              <h3 className="font-medium text-lg">{t('wizard.security.noStorage.title')}</h3>
              <p className="text-muted-foreground text-sm mt-1">
      ...
      <div className="bg-muted/30 rounded-lg p-4 mt-6 border border-border">
        <div className="flex items-start gap-2">
          <Icon icon="solar:info-circle-linear" className="text-muted-foreground mt-0.5 flex-shrink-0" />
          <div>
      ...
      <div className="flex justify-end mt-8">
        ...
        <Button onClick={handleContinue} variant="default" className="bg-primary hover:bg-primary/90 text-primary-foreground">
