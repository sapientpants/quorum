  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: { [key: string]: string } = {
        ...
        'welcome.consent.intro': 'Before you enter your API key, please understand how it will be handled:',
        'welcome.consent.points.storage': 'Your API key will be stored in your browser only.',
        'welcome.consent.points.processing': 'Your API key is only used to make requests to the AI provider.',
        'welcome.consent.points.access': 'We never see or store your API key on our servers.',
        ...
        'welcome.consent.agreement': 'I understand and consent to the storage of my API key as selected above.',
...
describe('ApiKeyConsentModal', () => {
  ...
  it('renders correctly with default values', () => {
    ...
    expect(screen.getByText(/Before you enter your API key/)).toBeInTheDocument()
  ...
  it('calls onContinue with local storage when selected', () => {
    ...
    const localStorageRadio = Array.from(radioInputs).find(
      radio => radio.parentElement?.textContent?.includes('Local Storage')
    )
  ...
  it('calls onContinue with no storage when selected', () => {
    ...
    const noStorageRadio = Array.from(radioInputs).find(
      radio => radio.parentElement?.textContent?.includes('No Storage')
    )
