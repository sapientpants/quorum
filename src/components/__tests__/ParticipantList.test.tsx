...
const mockUseParticipantsStore = useParticipantsStore as unknown as ReturnType<typeof vi.fn>
...
vi.mock('../ParticipantForm', () => ({
  ParticipantForm: ({ onSubmit, onCancel }: ParticipantFormProps) => (
    <div data-testid="participant-form">
      <button data-testid="mock-submit" onClick={() => onSubmit({ name: 'New AI', type: 'llm', provider: 'openai', model: 'gpt-4o' } as Omit<Participant, 'id'>)}>
        Submit
      </button>
