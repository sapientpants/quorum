...
beforeEach(() => {
  createTranslationMock({
    ...
    "apiKeys.openai.placeholder": "Enter your OpenAI API key",
    "apiKeys.storage.disclaimer":
      "Your API key is stored locally in your browser and never sent to our servers.",
    "common.buttons.showKey": "Show API key",
    "common.buttons.hideKey": "Hide API key",
  });
});
...
describe("ApiKeyInput", () => {
  ...
  it("toggles visibility when button is clicked", () => {
    ...
    let inputField = screen.getByPlaceholderText(
      "Enter your OpenAI API key",
    ) as HTMLInputElement;
    ...
    inputField = screen.getByPlaceholderText(
      "Enter your OpenAI API key",
    ) as HTMLInputElement;
