  ...
  useTranslation: () => ({
    t: (key: string) => {
      const translations: Record<string, string> = {
        ...
        'theme.themeToggleInfo': 'Toggle between your preferred light and dark themes',
        'theme.system': 'System',
...
vi.mock('@heroui/react', async () => {
  ...
  return {
    ...actual,
    Button: ({ onClick, children, 'aria-label': ariaLabel }: { onClick?: () => void, children: React.ReactNode, 'aria-label'?: string }) => (
      <button onClick={onClick} aria-label={ariaLabel} data-testid="button">{children}</button>
    )
  }
})
