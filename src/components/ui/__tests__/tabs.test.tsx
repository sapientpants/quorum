...
vi.mock('@radix-ui/react-tabs', () => ({
  Root: ({ className, children, defaultValue, id, 'aria-label': ariaLabel, ...props }: TabsComponentProps) => (
    <div 
  ...
  Trigger: ({ className, children, value, ...props }: TabsComponentProps & { value?: string }) => (
    <button 
  ...
  Content: ({ className, children, value, ...props }: TabsComponentProps & { value?: string }) => (
    <div 
...
describe('Tabs Components', () => {
  ...
  describe('TabsTrigger', () => {
    ...
    it('applies additional className to trigger', () => {
      render(<TabsTrigger className="custom-trigger" value="tab1">Tab 1</TabsTrigger>)
  ...
  describe('TabsContent', () => {
    ...
    it('applies additional className to content', () => {
      render(<TabsContent className="custom-content" value="tab1">Content 1</TabsContent>)
