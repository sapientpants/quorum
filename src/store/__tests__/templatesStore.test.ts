...
describe("templatesStore", () => {
  ...
  test("should return template with associated participants", () => {
    ...
    const { template, participants: templateParticipants } =
      store.getTemplateWithParticipants(templateId, participants);
  ...
  test("should return empty results for non-existent template ID", () => {
    ...
    const { template, participants: templateParticipants } =
      store.getTemplateWithParticipants("non-existent", participants);
