...
describe("ErrorContext", () => {
  ...
  it("handles online event", async () => {
    ...
    expect(screen.getByTestId("network-status")).not.toHaveTextContent(
      ConnectionQuality.OFFLINE,
    );
  });
