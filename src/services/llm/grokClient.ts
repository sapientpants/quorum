...
export class GrokClient implements LLMClient {
  private readonly supportedModels: GrokModel[] = ["grok-3", "grok-2"];
  ...
  async *streamMessage?(
    ...
    yield {
      ...
      error: new Error("Direct streaming not implemented for Grok"),
    };
  }
}
