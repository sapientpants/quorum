...
describe('OpenAIStreamClient', () => {
  ...
  describe('streamMessage', () => {
    ...
    if (typeof ReadableStream !== 'undefined' && typeof TextDecoder !== 'undefined') {
      ...
      it('handles abort signal', async () => {
        ...
        const stream = client.streamMessage(messages, 'test-key', 'gpt-4o', undefined, signal)
  ...
  describe('chat and chatStream', () => {
    it('chat method calls sendMessage with correct parameters', async () => {
      // Spy on sendMessage
      const sendMessageSpy = vi.spyOn(client, 'sendMessage').mockResolvedValue('Hello from OpenAI')
    ...
    it('chatStream method calls sendMessage with streaming options', async () => {
      // Spy on sendMessage
      const sendMessageSpy = vi.spyOn(client, 'sendMessage').mockImplementation(
